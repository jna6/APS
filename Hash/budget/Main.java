...
class Traveler {
        //implements Comparable<Traveler> {
    String firstName;
    String lastName;
    int budget;
    String ip_address;
...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < m; i++) {
            ...
            int count=0;
            int maxPrice=0;
            Traveler maxTraveler=null;

            for (int j = 0; j < list.size(); j++) {
                Traveler traveler=list.get(j);
                if (traveler.budget >= traveler.price) {
                    count++;
                    if (traveler.price > maxPrice) {
                        maxPrice=traveler.price;
                        maxTraveler=traveler;
                    }
                }
            }
            ...
            System.out.println(maxTraveler.firstName+" "+maxTraveler.lastName+" with salary "+ maxTraveler.budget+" from address "+maxTraveler.ip_address+" who spent "+maxTraveler.price+"\n");
        }
