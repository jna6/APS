package PAAAAKKKK.hash2023_24.Preveduvach;
...
class dictionary{
    ...
    public dictionary(String mk, String eng) {
        this.mk = mk;
        this.eng = eng;
    }
}
public class Preveduvac {
    public static void main(String[] args) {
        ...
        while (true){
            ...
            int node= table.search(line);
            if (node!=-1){
                System.out.println(table.getBucket(node).value);
            }else
                System.out.println("/");
