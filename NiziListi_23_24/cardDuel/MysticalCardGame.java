package NiziListi_23_24.cardDuel;
...
public class MysticalCardGame {
    ...
    public static void startDuel(SLL<Card> firstSorcererCards, SLL<Card> secondSorcererCards) {
        ...
        SLLNode<Card> firstPlayerFirstCard= firstSorcererCards.getFirst();
        SLLNode<Card> delete=null;

        int bestCard= firstPlayerFirstCard.element.significance();
        SLLNode<Card> nextCard= firstPlayerFirstCard.succ;

       while (nextCard!=null) {
           if (nextCard.element.significance() > bestCard) {
               bestCard = nextCard.element.significance();
               delete = nextCard;
           }
           nextCard = nextCard.succ;
       }
       SLLNode<Card> secondPlayerFirstCard= secondSorcererCards.getFirst();
       for (int i=0; i<4; i++){
            secondPlayerFirstCard=secondPlayerFirstCard.succ;
       }
       secondSorcererCards.insertBefore(delete.element,secondPlayerFirstCard);
